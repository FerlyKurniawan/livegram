...
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "8349591511:AAFcoR2s2ue0wRqd4nS4ccWpF3xKKxoB7d8")
...
TELEGRAM_SUPPORT_CHAT_ID = os.getenv("TELEGRAM_SUPPORT_CHAT_UD", "8038986965")
if (
